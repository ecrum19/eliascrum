    ...
    entries: [
      {
        ...
        description:
          "Solid Cockpit is a browser-based interface for managing Solid Pod data, editing permissions, handling notifications, and executing SPARQL queries. It also supports materializing query results for reuse.",
